...
def test_get_mask_card_number(card_numbers: str) -> None:
...
def test_get_mask_card_numbers(card_numbers: str, expected: str) -> None:
...
def test_get_mask_accounts(account_numbers: str, expected: str) -> None:
    assert get_mask_account(account_numbers) == expected


def test_get_mask_accounts_invalid_account_number() -> None:
