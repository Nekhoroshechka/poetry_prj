...
def test_filter_by_state_without_state(list_of_dicts: list[dict]) -> None:
    assert (
        filter_by_state(
            [
...
def test_filter_by_state_other(list_of_dicts: list[dict], state: str, expected: list[dict]) -> None:
...
def test_sort_by_data(list_of_dicts: list[dict], sorting_direction: bool, expected: list[dict]) -> None:
    assert sort_by_date(list_of_dicts, sorting_direction=sorting_direction) == expected


def test_sort_by_data_same_data(list_of_dicts: list[dict]) -> None:
    assert sort_by_date(
        [
            {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
...
def test_sort_by_data_non_standard(list_of_dicts: list[dict], expected: list[dict]) -> None:
    assert sort_by_date(list_of_dicts) == expected


def test_sort_by_data_empty(list_of_dicts: list[dict]) -> None:
    assert sort_by_date(
        [
            {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
